...
class MoviesTvFragment : ComposeHostFragment() {
    ...
    override fun ScreenContent() {
        ...
        MoviesScreen(
            ...
            onMovieLongClick = { movie ->
                ShowOptionsDialog(requireContext(), movie, isTv = true).show()
            },
    ...
    private fun openMovie(movie: Movie) {
        findNavController().navigate(
            MoviesTvFragmentDirections.actionMoviesToMovie(id = movie.id),
        )
    }
}
