...
import com.betterstreamflix.databinding.ItemSettingMobileBinding
import com.betterstreamflix.databinding.ViewPlayerSettingsMobileBinding
import com.betterstreamflix.utils.dp
import com.betterstreamflix.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.betterstreamflix.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.betterstreamflix.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.betterstreamflix.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.betterstreamflix.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
