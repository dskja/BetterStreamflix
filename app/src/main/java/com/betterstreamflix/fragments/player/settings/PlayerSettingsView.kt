...
import com.betterstreamflix.utils.OpenSubtitles
import com.betterstreamflix.utils.mediaServers
import com.betterstreamflix.utils.SubDL
import com.betterstreamflix.utils.SubtitleOffset
import com.betterstreamflix.utils.UserPreferences
import com.betterstreamflix.utils.dp
import com.betterstreamflix.utils.findClosest
import com.betterstreamflix.utils.getAlpha
import com.betterstreamflix.utils.getRgb
import com.betterstreamflix.utils.mediaServerId
import com.betterstreamflix.utils.mediaServers
import com.betterstreamflix.utils.setAlpha
import com.betterstreamflix.utils.setRgb
import com.betterstreamflix.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.betterstreamflix.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.betterstreamflix.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.betterstreamflix.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.betterstreamflix.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
