...
open class FilemoonExtractor : Extractor() {
    ...
    override suspend fun extract(link: String): Video {
        ...
        Log.i("BetterStreamflix", "[Filemoon] Extraction started for: $link")

        // 1. Details
        val detailsUrl = "$currentDomain/api/videos/$videoId/embed/details"
        Log.i("BetterStreamflix", "[Filemoon] Details Request: $detailsUrl")
        ...
        Log.i("BetterStreamflix", "[Filemoon] Playback Domain detected: $playbackDomain")

        // 2. Challenge
        val challengeUrl = "$playbackDomain/api/videos/access/challenge"
        Log.i("BetterStreamflix", "[Filemoon] Challenge Request: $challengeUrl")
        ...
        Log.i("BetterStreamflix", "[Filemoon] Challenge Data: ID=$challengeId, Viewer=$viewerId")

        // 3. Attestation
        val attestation = generateAttestation(nonce)
        val attestUrl = "$playbackDomain/api/videos/access/attest"
        Log.i("BetterStreamflix", "[Filemoon] Attest Request: $attestUrl")
        ...
        Log.i("BetterStreamflix", "[Filemoon] Attest Token obtained (Confidence: $confidence)")

        // 4. Playback
        val playbackUrl = "$playbackDomain/api/videos/$videoId/embed/playback"
        Log.i("BetterStreamflix", "[Filemoon] Playback Request: $playbackUrl")
        ...
        Log.i("BetterStreamflix", "[Filemoon] Decrypting data...")
        ...
        Log.i("BetterStreamflix", "[Filemoon] SOURCE FOUND: $sourceUrl")
