...
import com.dskja.betterstreamflix.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.dskja.betterstreamflix.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {
