...
class DeepLinkHandlerTest {
    ...
    @Test
    fun movieUri_withProvider_roundTrips() {
        val uri = DeepLinkHandler.movieUri("id42", "SerienStream")
        assertThat(DeepLinkHandler.parse(uri)).isEqualTo(DeepLink.Movie("id42", "SerienStream"))
    }
}
