...
| `ic_launcher-512.png` | 512×512 launcher preview |
| `ic_launcher_foreground-432.png` | Adaptive-icon foreground source |
| `tv-banner-1280x720.png` | Android TV / promotional banner |

App mipmaps under `app/src/main/res/mipmap-*` are generated from these sources.
Background for adaptive icons is `#000000`.
